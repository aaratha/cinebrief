    ...
    return (
        <div className=" w-[44vw] max-w-[44vw] m-3 ml-6 bg-primary border border-white border-opacity-25 rounded-md justify-between flex flex-col">
            <div className="flex flex-col">
                <h1 className="text-center mt-4 text-xl border border-white border-opacity-25 rounded-md p-2 max-w-full m-4 mb-0 bg-gradient-to-r from-secondary to-tertiary">Movie Information</h1>
                <p className="m-7 mt-6">{info}</p>
            </div>
            <div className="m-4 mt-0">
                <h1 className=" rounded-t-md w-[6rem] text-center p-1 border-b-0 bg-secondary">Top Cast</h1>
